...
export class ExtendedColorMatrixFilter extends PIXI.filters.ColorMatrixFilter {
     ...
     */
    lumaGreyscale(greyscale: number, multiply: boolean) {
        const lumR = 0.2126;
        const lumG = 0.7152;
        const lumB = 0.0722;
     ...
     *  just set the current matrix with @param matrix
     */
    flood(red: number, green: number, blue: number, floodOpacity: number, multiply?: boolean) {
     ...
     *  just set the current matrix with @param matrix
     */
    private loadMatrix(matrix:  ColorMatrix, multiply = false): void
    {
     ...
     */
    private multiply(out: ColorMatrix, a: ColorMatrix, b: ColorMatrix): ColorMatrix
    {
        // Red Channel
     ...
     */
    private colorMatrix(matrix: ColorMatrix): ColorMatrix
    {
        // Create a Float32 Array and normalize the offset component to 0-1
