...
let html = require('../assets/rating.html');
let htmlOnlySocials = require('../assets/ratingOnlySocials.html');
let emptyStarIcon = require('../assets/emptyStar.svg?raw');
let filledStarIcon = require('../assets/filledStar.svg?raw');
