...
// right to left.
	class Pointer {
		constructor(manager, id) {
			...
			//  Coordinates and time of the pointer when Button 1 (left button), or Touch, was pressed, used for
			// dragging objects
			this.downX = 0;
			this.downY = 0;
			this.downTime = 0;

			//  Coordinates and time of the pointer when Button 1 (left button), or Touch, was released, used for
			// dragging objects
			this.upX = 0;
			this.upY = 0;
			this.upTime = 0;
