	...
	function (Game, GameObject, PIXI, Preloading, Utils, InjectedSVG, Constants, GraphicsConfig) {
		...
		class Tree extends Resource {
			constructor(x, y, size) {
				super(Game.layers.resources.trees, x, y, size * 1.8 + GraphicsConfig.character.size, 0);

				this.resourceSpotTexture = new InjectedSVG(Tree.resourceSpot.svg, x, y, this.size * 0.7, Utils.randomRotation());
