...
func (rcv *OngoingAction) TicksLeft() uint16 {
	return rcv._tab.GetUint16(rcv._tab.Pos + flatbuffers.UOffsetT(0))
}
func (rcv *OngoingAction) MutateTicksLeft(n uint16) bool {
...
func CreateOngoingAction(builder *flatbuffers.Builder, ticksLeft uint16, actionType byte) flatbuffers.UOffsetT {
	builder.Prep(2, 4)
	builder.Pad(1)
	builder.PrependByte(actionType)
	builder.PrependUint16(ticksLeft)
